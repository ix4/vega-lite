...
import {GradientLinear, GradientRadial} from 'vega';
...
export type ChannelDefWithCondition<F extends FieldDef<any>, V extends ValueOrGradient> =
 ...
 * @minProperties 1
 */
export type ValueDefWithCondition<F extends FieldDef<any>, V extends ValueOrGradient = ValueOrGradient> = Partial<
  ValueDef<V>
> & {
  /**
...
export interface ConditionValueDefMixins<V extends ValueOrGradient = ValueOrGradient> {
  /**
